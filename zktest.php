...
<?php
    ...
    require_once "src/zklib.php"; 
    require_once "src/zkattendance.php"; 
    require_once "src/zkconnect.php"; 
    require_once "src/zkconst.php"; 
    require_once "src/zkdevice.php"; 
    require_once "src/zkface.php"; 
    require_once "src/zkos.php"; 
    require_once "src/zkpin.php"; 
    require_once "src/zkplatform.php"; 
    require_once "src/zkserialnumber.php"; 
    require_once "src/zkssr.php"; 
    require_once "src/zktime.php"; 
    require_once "src/zkuser.php"; 
    require_once "src/zkversion.php"; 
    require_once "src/zkworkcode.php"; 
   
    $zk = new ZKLib("192.168.1.204", 4370);
