                ...
                <div class="container-fluid">
                    ...
                    <?php  
                        ...
                        if($ret)
                        {
                            ...
                            echo 'Version OS'.$zk->osVersion().'<br/>'; 
                            echo 'Platform '.$zk->platform().'<br/>';
                            echo 'Firmware Version '.$zk->fmVersion().'<br/>';
                            echo 'WorkCode '.$zk->workCode().'<br/>'; 
                            echo 'SSR '.$zk->ssr().'<br/>'; 
                            echo 'Pin Width '.$zk->pinWidth().'<br/>';
                            echo 'Face Function On '.$zk->faceFunctionOn().'<br/>';
                            echo 'Serial Number '.$zk->serialNumber().'<br/>';
                            echo 'Device Name '.$zk->deviceName().'<br/>'; 
                            echo 'Get Time '.$zk->getTime().'<br/>';
