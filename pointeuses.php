...
<head>
    ...
    <title>ZKTeco Administration - Pointeuses</title>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800"><i class="fas fa-list fa-sm fa-fw mr-2 text-gray-900"></i>Pointeuses</h1>
                    </div>
                        ...
                        <div class="col-lg-12 mb-4">
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Pointeurse Disponible : <?=$Name?></h6>
                                </div>
                                <div class="card-body">
                                <form  method="POST" action="">
                                        <div class="form-group row">
                                            <div class="col-sm-6 mb-3 mb-sm-0">
                                                Nom Pointeuse<br/>
                                                <input type="text" class="form-control form-control-user" name="NomUsers" id="NomUsers" value="<?php echo $Name; ?>" readonly="true">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <div class="col-sm-6 mb-3 mb-sm-0">
                                                Sérial Number<br/>
                                                <input type="text" class="form-control form-control-user" name="NomUsers" id="NomUsers" value="<?php echo $serialNumber;?>" readonly="true">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <div class="col-sm-6">
                                               Version<br/>
                                                <input type="text" class="form-control form-control-user" name="EmailUsers" id="EmailUsers" value="<?php echo $version;?>" readonly="true">
                                            </div>
                                            <div class="col-sm-6">
                                               OS Version<br/>
                                                <input type="text" class="form-control form-control-user" name="PrenomUsers" id="PrenomUsers" value="<?php echo $osVersion;?>" readonly="true">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <div class="col-sm-6">
                                               Platforme<br/>
                                                <input type="text" class="form-control form-control-user" name="EmailUsers" id="EmailUsers" value="<?php echo $platform;?>" readonly="true">
                                            </div>
                                            <div class="col-sm-6">
                                               Frimware Version<br/>
                                                <input type="text" class="form-control form-control-user" name="PrenomUsers" id="PrenomUsers" value="<?php echo $fmVersion;?>" readonly="true">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <div class="col-sm-6">
                                               Work Code<br/>
                                                <input type="text" class="form-control form-control-user" name="EmailUsers" id="EmailUsers" value="<?php echo $workCode;?>" readonly="true">
                                            </div>
                                            <div class="col-sm-6">
                                              SSR<br/>
                                                <input type="text" class="form-control form-control-user" name="PrenomUsers" id="PrenomUsers" value="<?php echo $ssr;?>" readonly="true">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <div class="col-sm-6">
                                              PIN<br/>
                                                <input type="text" class="form-control form-control-user" name="EmailUsers" id="EmailUsers" value="<?php echo $pinWidth;?>" readonly="true">
                                            </div>
                                            <div class="col-sm-6">
                                              Face Function ON<br/>
                                                <input type="text" class="form-control form-control-user" name="PrenomUsers" id="PrenomUsers" value="<?php echo $faceFunctionOn;?>" readonly="true">
                                            </div>
                                        </div>
                                        <hr>
                                    </form>
