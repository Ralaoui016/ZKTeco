...
<head>
    ...
    <title>ZKTeco Administration - Setting</title>
...
<body id="page-top">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800"><i class="fas fa-cogs fa-sm fa-fw mr-2 text-gray-900"></i>Setting</h1>
                    </div>
                        ...
                        <div class="col-lg-12 mb-4">
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Fichier de Configuration *.ini : <?=basename("./ini/Config.ini", ".ini").PHP_EOL;?></h6>
                                    <?php 
                                        $ErreurFileIni = $_SESSION["ErreurFileIni"] ?? "";
                                        echo $ErreurFileIni;
                                    ?>
                                    <div class="align-items-center" align="right">
                                        <a onclick="SetReadOnly()" class="btn btn-secondary btn-icon-split">
                                            ...
                                            <span class="text" id="BtEdit">Modifier</span>
                                        </a>
                                    </div>
                                </div>
                                <div class="card-body">
                                    <form method="POST" action="control/F_UpdateFile.php">
                                        <div class="form-group row">
                                            <div class="col-sm-12 mb-3 mb-sm-0">
                                                Fichier Configuration<br/>
                                                <textarea rows="10" class="form-control form-control-user" name="FileConfig" id="FileConfig" readonly="true">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-3">
                                                <button type="submit" class="btn btn-success btn-icon-split btn-block" ><span class="icon text-white-50">
                                                    <i class="far fa-edit"></i>
                                                </span>
                                                <span class="text">Modifier</span></button>
                                            </div>
                                            <div class="col-lg-3">
                                                <button type="reset" class="btn btn-warning btn-icon-split btn-block" ><span class="icon text-white-50">
    ...
    <script>
        ...
        function SetReadOnly() 
        {
            ...
            {
                document.getElementById("FileConfig").readOnly = false; 
                document.getElementById("BtEdit").innerHTML="Annuler";
            }
            else
            {
                document.getElementById("FileConfig").readOnly = true;
